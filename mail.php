<?php
    ...
    // include "waiting.php";
    // // 건네 받은 정보 : $next_cno, $isbn
    // // 정보를 waiting.php에 저장하도록 한다.
    // $cno_isbn_map[$next_cno] = $isbn;
    // $cno_date_map[$next_cno] = date("Y-m-d");
    ...
    SET CNO = :next_cno, DATERENTED = :now_date
    WHERE ISBN = :isbn 
    ");
    $now_date = date("Y-m-d");
    $stmt -> execute(array($next_cno, $now_date, $isbn));
